#refer to brats medloader for example
...
class TestDataset(Dataset):
    ...
    def __init__(self):
        ...
        self.training_path = self.root + '/macai/training_data/'
        self.testing_path = self.root + '/macai/validation_data/'
        ...
        self.save_name = self.root + '/maciai/macai-list-' + mode + '-samples-' + str(samples) + '.txt'
        ...
        self.sub_vol_path = self.root + '/macai/generated/' + mode + subvol + '/'
        ...
        if self.mode == 'train':
            print('macai, Total data:', len(list_IDsT1))
            ...
            self.list = create_sub_volumes(list_IDsT1, list_IDsT1ce, list_IDsT2, list_IDsFlair, labels,
                                           dataset_name="macai", mode=mode, samples=samples,
